...
def create_hero_menu_for_user(user: discord.Member, hero_index: int) -> discord.Embed:
    """Creates a Hero Embed with extra context and information on the owning player. For use in scrollable Hero Menus in list_hero"""
